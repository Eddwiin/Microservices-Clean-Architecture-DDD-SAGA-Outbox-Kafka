...
import org.food.ordering.system.service.domain.dto.create.OrderItem;
...
public class OrderApplicationServiceTest {
    ...
    private final UUID CUSTOMER_ID = UUID.fromString("absc-dee-ere");
    private final UUID RESTAURANT_ID = UUID.fromString("absc-dee-ere");
    private final UUID PRODUCT_ID = UUID.fromString("absc-dee-ere");
    private final UUID ORDER_ID = UUID.fromString("absc-dee-ere");
...
//        assertEquals("Order item price: 250.00 is not valid for product 200.00", orderDomainException.getMessage());
//    }
//
//    @Test
